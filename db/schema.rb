...
ActiveRecord::Schema.define(version: 20170716152110) do
  ...
  create_table "my_polls", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["user_id"], name: "index_my_polls_on_user_id", using: :btree
  end
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["my_poll_id"], name: "index_questions_on_my_poll_id", using: :btree
  end
